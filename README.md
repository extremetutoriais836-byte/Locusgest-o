...
**Sobre o peso:** o `index.html` tem ~790 KB porque carrega tudo dentro de si. Em troca, a página não quebra se algum arquivo se perder no deploy. O vídeo do CEO fica no YouTube e só é carregado no clique, então **a página abre sem nenhuma requisição externa**.
